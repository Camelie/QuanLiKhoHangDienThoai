...
public class TrangChu extends JPanel {
    ...
    JLabel title, subTit, infoDetail[], objDetail[], objDetail1[], infoIcon[];
        ...
        /*
            String[][] getSt = {
        {"Tính chính xác", "tinhchinhxac_128px.svg", "Quản lý chính xác đến từng sản phẩm dựa trên mã IMEI độc nhất. Hệ thống đảm bảo dữ liệu kho hàng luôn được cập nhật đúng thời gian thực, giảm thiểu tối đa sai sót và thất thoát."},
        {"Tính bảo mật", "tinhbaomat_128px.svg", "Bảo vệ toàn diện cho kho hàng của bạn khỏi các rủi ro về gian lận hay trộm cắp. Dễ dàng theo dõi và kiểm soát trạng thái của từng thiết bị, đảm bảo an toàn tối đa cho tài sản."},
        {"Tính hiệu quả", "tinhhieuqua_128px.svg", "Tối ưu hóa quy trình quản lý kho với các công cụ thông minh và báo cáo trực quan. Tiết kiệm thời gian trong việc nhập, xuất, kiểm kê hàng hóa và nâng cao năng suất hoạt động."}
    };
        */
